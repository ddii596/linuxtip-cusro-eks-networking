...
resource "aws_ssm_parameter" "private_subnetsame" {
...
resource "aws_ssm_parameter" "database" {
    ...
    type = "String"
    name = "/${var.project_name}/${var.database_subnets[count.index].availability_zone}/${var.database_subnets[count.index].name}"
